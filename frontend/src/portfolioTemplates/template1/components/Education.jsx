      ...
      <div className="columns-2  px-10 py-20 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Following is my education history with college name and my education details.
          </p>
        </div>
          ...
          {educations && educations.map((edu) => (
            <Grid item md={4}  className="p-4 transform hover:scale-125 ease-in-out duration-500">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-1 border-gray-800 bg-gray-700 ">
