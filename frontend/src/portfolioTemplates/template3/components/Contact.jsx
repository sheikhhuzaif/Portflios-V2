...
export default function Contact() {
  return (
    <section id="contact" className=" pt-10 pb-56">
      <div className="container py-20 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="flex flex-col mb-20  items-center justify-center">
          ...
          <div className="flex">
            ...
            <a href="" className="p-5 transform hover:scale-125 ease-in-out duration-500"><GitHubIcon /></a>
            <a href="" className="p-5 transform hover:scale-125 ease-in-out duration-500"><TelegramIcon /></a>
          </div>
        </div>
