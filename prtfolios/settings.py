"""
Django settings for prtfolios project.
...
from .secrets import secret_key, db_name, db_user, db_password
...
WSGI_APPLICATION = 'prtfolios.wsgi.application'
